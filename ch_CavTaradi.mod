...
NEURON {
	SUFFIX ch_CavTaradi				: The name of the mechanism
...
PROCEDURE rates(v) {  :Computes rate and other constants at current v.
       ...
       q10 = 3^((celsius - 34)/10)
        ...
        alpha = 0.2*vtrap(19.26-v,10)
	beta = 0.009*exp(-v/22.03)
	sum = alpha+beta        
	ctau = 1/sum      cinf = alpha/sum
                :"d" NCa inactivation system
	alpha = .000001*exp(-v/16.26) : this is multiplied, not divided in Aradi & Holmes formula
